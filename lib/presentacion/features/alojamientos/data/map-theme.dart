  ...
  },
  {
    ...
    List<FormularioOpinion> formulariosOpiniones = [
      ...
      FormularioOpinion(
        ...
        opionLugarDestino:
            'Machu Picchu es impresionante, una experiencia única.',
        motivoViaje: 'Turismo',
      ),
      FormularioOpinion(
        titulo: 'Esperamos Opinión',
      ...
      FormularioOpinion(
        ...
        opinionAlojamiento:
            'Lugar perfecto para relajarse, excelente servicio.',
        opionLugarDestino:
      ...
      FormularioOpinion(
        ...
        opinionAlojamiento:
            'Muy buen servicio, habitaciones cómodas y limpias.',
        opionLugarDestino:
      ...
      FormularioOpinion(
        ...
        opionLugarDestino:
            'Cusco es una ciudad maravillosa con mucho que ofrecer.',
