...
import 'package:app_p2sw1/presentacion/features/home/screen/components/formCustom-auth.dart';
  ...
  Widget build(BuildContext context) {
    ...
    const decoration1 = BoxDecoration(
        image: DecorationImage(
            image: NetworkImage(
                "https://i.pinimg.com/564x/d1/b7/ff/d1b7ffc64aba389f21fb01deae0ccb01.jpg"),
            fit: BoxFit.cover));
    final decoration2 =
          ...
          children: [
            ...
            Positioned(
              ...
              child: SizedBox(
                ...
                height: size.height * 0.16,
                child: Text(
                    "¡Bienvenidos! Donde la excelencia educativa comienza.",
                    textAlign: TextAlign.center,
                    maxLines: 3,
                    style: GoogleFonts.anta(
                      fontSize: 25,
